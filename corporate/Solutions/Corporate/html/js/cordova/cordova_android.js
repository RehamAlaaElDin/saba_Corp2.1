...
// Handler for the cordova_plugins_android.js content.
...
exports.load = function (callback) {
    ...
    if (pathPrefix === null) {
        console.log('Could not find cordova_android.js script tag. Plugin loading may fail.');
        pathPrefix = '';
    }
    injectIfNecessary('cordova/plugin_list', pathPrefix + 'cordova_plugins_android.js', function () {
