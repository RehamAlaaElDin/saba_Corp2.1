...
<br />
<br />
<font size="15">Guarantee Amendment Record</font>
<br />
<br />
...
<div style="width:100%;clear:both;">
<table width="100%" border="1" bordercolor="ffffff" cellspacing="2" cellpadding="5" cellsfitpage="true">
<tr><td rowspan="2"><font size="10"><b>Guarantee Amendment Details</b></font></td></tr>
</table>
<font size="8">
<table width="100%" border="1" bordercolor="ffffff" cellspacing="2" cellpadding="5" cellsfitpage="true">
   ...
   $%if GuaranteeDetails[C].LimitExReason != ''$  
    ...
    $%endif$
    $%if GuaranteeDetails[C].MdibPrinMovement != ''$ 
	<tr>
	 <td bgcolor="DBE5F1"><b>Requested Change In Principal Amount</b></td>
	 <td bgcolor="DBE5F1">$$GuaranteeDetails[C].MdibPrinMovement$</td>
    </tr>
	$%endif$	
	$%if GuaranteeDetails[C].MovementDate != ''$  
	<tr>
	 <td bgcolor="DBE5F1"><b>Request Date Of Principal Change</b></td>
	 <td bgcolor="DBE5F1">$$GuaranteeDetails[C].MovementDate$</td>
    </tr>
	$%endif$
	$%if GuaranteeDetails[C].NewExpiryDate != ''$  
	<tr>
	 <td bgcolor="DBE5F1"><b>New Expiry Date</b></td>
	 <td bgcolor="DBE5F1">$$GuaranteeDetails[C].NewExpiryDate$</td>
    </tr>
	$%endif$
