...
<tr>
<td bgcolor="95B3D7">Transaction Reference</td><td bgcolor="95B3D7">$$InputParameters[1].ImportLCDrawingList[C].TransRef$</td>
</tr>
</table>
...
<table width="100%" border="1" bordercolor="ffffff" cellspacing="2" cellpadding="5" cellsfitpage="true">
   ...
   $%endif$
   $%if DrawingDetails[C].BookingDate != ''$ 
	<tr>
	    <td bgcolor="DBE5F1"><b>Creation Date</b></td>
		<td bgcolor="DBE5F1">$$DrawingDetails[C].BookingDate$</td>
	</tr>
   $%endif$
   $%if DrawingDetails[C].PresentorRef != ''$ 
	<tr>
	    <td bgcolor="DBE5F1"><b>Presentor Reference</b></td>
		<td bgcolor="DBE5F1">$$DrawingDetails[C].PresentorRef$</td>
	</tr>
   $%endif$
   $%if DrawingDetails[C].Presentor[C].Presentor != ''$ 
	<tr>
	    <td bgcolor="DBE5F1"><b>Presentor</b></td>
		<td bgcolor="DBE5F1">$$DrawingDetails[C].Presentor[C].Presentor$</td>
	</tr>
   $%endif$
   $%if DrawingDetails[C].DocsReceived != ''$ 
	<tr>
	    <td bgcolor="DBE5F1"><b>Documents Received</b></td>
		<td bgcolor="DBE5F1">$$DrawingDetails[C].DocsReceived$</td>
	</tr>
   $%endif$
   $%if DrawingDetails[C].FwdContract[C].ForwardContract != ''$ 
	<tr>
	    <td bgcolor="DBE5F1"><b>Forward Contract</b></td>
		<td bgcolor="DBE5F1">$$DrawingDetails[C].FwdContract[C].ForwardContract$</td>
	</tr>
   $%endif$
   $%if DrawingDetails[C].GteeReference != ''$ 
	<tr>
	    <td bgcolor="DBE5F1"><b>Shipping Guarantee Reference</b></td>
		<td bgcolor="DBE5F1">$$DrawingDetails[C].GteeReference$</td>
	</tr>
   $%endif$
   $%if DrawingDetails[C].MaturityReview != ''$ 
	<tr>
	    <td bgcolor="DBE5F1"><b>Maturity Date</b></td>
		<td bgcolor="DBE5F1">$$DrawingDetails[C].MaturityReview$</td>
	</tr>
   $%endif$
</table>
</font>
...
<font size="8">
<table width="100%" border="1" bordercolor="ffffff" cellspacing="2" cellpadding="5" cellsfitpage="true">
   $%if DownloadDrawing[1].ResponseForDocuments != ''$
  <tr>
  <td bgcolor="DBE5F1"><b>Response to Discrepancies</b></td>
  <td bgcolor="DBE5F1">$$DrawingDetails[C].ApplRespDiscrep$</td>
  </tr>  
  $%endif$
</table>
...
<table width="100%" border="1" bordercolor="ffffff" cellspacing="2" cellpadding="5" cellsfitpage="true">
  <tr>
	...
	<td bgcolor="DBE5F1"><b>Discrepancy Status</b></td>
  </tr>
$%for 1 to DrawingDetails[1].ConDiscrepancy[C].lastInstance() $
  <tr>
	...
	<td bgcolor="DBE5F1">$$DrawingDetails[1].ConDiscrepancy[C].DiscrepancyStatusForDisplay$</td>
  </tr>
$%endfor$
</table>
$%endif$
...
<table width="100%" border="1" bordercolor="ffffff" cellspacing="2" cellpadding="5" cellsfitpage="true">
   ...
   $%endif$
   $%if DrawingDetails[C].DrawdownAccount != ''$ 
	<tr>
	    <td bgcolor="DBE5F1"><b>Account to be Debited for the Documents</b></td>
		<td bgcolor="DBE5F1">$$DrawingDetails[C].DrawdownAccount$</td>
	</tr>
   $%endif$
...
<div style="width:100%;clear:both;">
<br/>
$%if InputParameters[1].ImportLCDrawingList[C].StatusForDisplay == "Approved"$
<table width="100%" border="1" bordercolor="ffffff" cellspacing="2" cellpadding="5" cellsfitpage="true">
