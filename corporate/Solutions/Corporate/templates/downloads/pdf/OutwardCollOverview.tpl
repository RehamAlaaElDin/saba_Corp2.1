...
<br />
<br />
<font size="15">Outward Collection</font>
<br />
<br />
<font size="8">
...
<tr><td rowspan="2"><font size="10"><b>Outward Amendment Collections</b></font></td></tr>
</table>
<font size="8">
<!---Outward Amendment Collections--->
<div style="width:100%;clear:both;">
<table width="100%" border="1" bordercolor="ffffff" cellspacing="2" cellpadding="5" cellsfitpage="true">
  $%if LetterOfCreditOverview[C].OldAmendments[2].OldAmendments != ''$
  <tr>
     <td bgcolor="DBE5F1"><b>Old amount</b></td>
	 <td bgcolor="DBE5F1">$$LetterOfCreditOverview[C].OldAmendments[2].OldAmendments$</td>
  </tr>
  $%endif$
  $%if LetterOfCreditOverview[C].OldAmendments[1].OldAmendments != ''$
  <tr>  
     <td bgcolor="DBE5F1"><b>Old maturity date</b></td>
	 <td bgcolor="DBE5F1">$$LetterOfCreditOverview[C].OldAmendments[1].OldAmendments$</td>
  </tr>
  $%endif$
 ...
 $%endif$
      $%if LetterOfCreditOverview[C].Amendments[C].Amendments != ''$
  <tr>
      	<td bgcolor="DBE5F1"><b>Amendments</b></td>
		<td bgcolor="DBE5F1">$$LetterOfCreditOverview[C].Amendments[C].Amendments$</td>
  </tr>
   $%endif$
...
<table width="100%" border="1" bordercolor="ffffff" cellspacing="2" cellpadding="5" cellsfitpage="true">
<tr><td rowspan="2"><font size="10"><b>Outward Collection Details</b></font></td></tr>
</table>
<font size="8">
<!---Outward Collection Details--->
<div style="width:100%;clear:both;">
<table width="100%" border="1" bordercolor="ffffff" cellspacing="2" cellpadding="5" cellsfitpage="true">
  ...
  <tr>  
     <td bgcolor="DBE5F1"><b>Collecting bank name and address</b></td>
  ...
  <tr>
	 <td bgcolor="DBE5F1"><b>Drawee name and address</b></td>
...
<table width="100%" border="1" bordercolor="ffffff" cellspacing="2" cellpadding="5" cellsfitpage="true">
	...
	$%endif$
	  $%if LetterOfCreditOverview[C].Instructions[C].Instructions != ''$  
	    <tr>
	<td bgcolor="DBE5F1"><b>Remarks</b></td>
	<td bgcolor="DBE5F1">$$LetterOfCreditOverview[C].Instructions[C].Instructions$</td>
	  </tr>
$%endif$
</table>
</div>
...
<div style="width:100%;clear:both;">
<br/>
$%if InputParameters[1].OutwardCollectionsList[C].EventStatus == 'Approved' OR InputParameters[1].OutwardCollectionsList[C].EventStatus == 'Rejected' OR InputParameters[1].OutwardCollectionsList[C].EventStatus == 'With Bank'$
<table width="100%" border="1" bordercolor="ffffff" cellspacing="2" cellpadding="5" cellsfitpage="true">
