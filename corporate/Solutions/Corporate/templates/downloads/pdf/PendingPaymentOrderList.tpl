...
<br />
<br />
<font size="15">Pending $$!MAINSESSION.TRANSFER_TYPE$</font>
<br />
<br />
...
$%for 1 to PaymentOrderList[C].lastInstance() $
  <tr>
	...
	<td bgcolor="DBE5F1" align="right">$$PaymentOrderList[C].CurrencySymbol$ $%IF PaymentOrderList[C].PaymentAmount > 0$+$%ENDIF$ $$PaymentOrderList[C].PaymentAmount$</td>
  </tr>
$%endfor$
</table>
